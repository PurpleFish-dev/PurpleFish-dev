...
namespace QifApi.Logic
{
    internal static class InvestmentLogic
    {
        ...
        public static List<InvestmentTransaction> Import(string transactionItems, ref QifDom.yearFormat yearFormat, ref QifDom.dayMonthFormat dayMonthFormat)
        {
