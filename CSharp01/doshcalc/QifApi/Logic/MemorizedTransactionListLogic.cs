...
namespace QifApi.Logic
{
    internal static class MemorizedTransactionListLogic
    {
        ...
        public static List<MemorizedTransactionListTransaction> Import(string transactionItems, ref QifDom.yearFormat yearFormat, ref QifDom.dayMonthFormat dayMonthFormat)
        {
                ...
                if (sEntry.Length > 0)
                {
                    ...
                    switch (sEntry[0].ToString())
                    {
                        ...
                        case MemorizedTransactionListFields.AmortizationFirstPaymentDate:
                            // Set the date value
                            mtlt.RawDate(sEntry.Substring(1));
