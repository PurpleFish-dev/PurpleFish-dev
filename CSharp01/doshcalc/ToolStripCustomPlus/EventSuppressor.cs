...
//modified from code published on stackoverflow.com author unknown
...
namespace ToolStripCustomCtrls
{
    public class EventSuppressor
    {
        ...
        public EventSuppressor(Component control)
        {
            if (control == null)
    ...
    public enum DisplayStyleSelection
    {
        None,
        TextOnOff,
        IconsOnOff,
    ...
    public enum ListViewDisplayStyle
    {
        Tiles,
        List
    }
